...
// ===========================
// GET MECHANIC'S FUNDS REALISED FOR CURRENT YEAR, MONTH, AND DAY
// ===========================
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center pd-20">
							...
							<div class="widget-data">
								<div class="h4 mb-0">
									<span><?php echo $ada_this_year; ?></span> 
				...
				<div class="col-xl-4 mb-30">
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center pd-20">
							...
							<div class="widget-data">
								<div class="h4 mb-0">
									<span><?php echo $ada_this_month; ?></span> 
									<span class="h6">ADA</span>
								</div>
...
async function fetchAdaPrice() {
    try {
        ...
        document.getElementById('loadingState').innerHTML = `
            <span style="color: #f87171;"> Unable to fetch live rate. Retrying...</span>
        `;
    }
}
